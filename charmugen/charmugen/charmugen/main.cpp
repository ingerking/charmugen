...
int WINAPI WinMain(HINSTANCE hInst, HINSTANCE, LPSTR, INT){
	...
	HWND hWnd=CreateWindow(L"cmugen", L"mugen v.test", WS_OVERLAPPED|WS_MINIMIZEBOX|WS_MAXIMIZEBOX|WS_SYSMENU, 0, 0, 200, 100, NULL, NULL, wc.hInstance, NULL);
		
	RECT rect;
	GetClientRect(hWnd, &rect);
	int x=1200-rect.right;
...
//	_CrtSetBreakAlloc(252);
	...
	UnregisterClass(L"cmugen", wc.hInstance);
